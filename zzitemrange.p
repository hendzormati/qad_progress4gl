...
define variable     numItemStart    as character    initial " Acess-CD001"    no-undo.
define variable     numItemEnd      as character    initial "0003"            no-undo.
...
define temp-table tt_item
    ...
    field  tt_Cost_Standard like    sct_cst_tot
    field  tt_Cost_Current  like    sct_cst_tot.
...
define frame itemDetailsframe
    ...
    tt_Cost_Standard  label "Cost Standard"
    tt_Cost_Current   label "Cost Current".
